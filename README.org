...
- [[#announcement][Announcement]]
  ...
  - [[#new-keybinding-for-snippet][New keybinding for snippet]]
...
** New keybinding for snippet
Instead of tab, now, to toggle and go forward on snippet, press C-o.  Tab is now for autocomplete only.
