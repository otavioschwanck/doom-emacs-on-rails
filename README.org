...
- [[#troubleshoot][Troubleshoot]]
  - [[#disable-robe-start-when-use-go-to-definition-definition][Disable robe start when use go to definition definition]]
...
* Troubleshoot
** Disable robe start when use go to definition definition
add this to your user.el:
