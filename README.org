...
- [[#emacs-handbook-with-best-commands][Emacs Handbook with best commands]]
...
* Emacs Handbook with best commands
...
| SPC m m             | normal             | Extract Method                              |
| SPC m n             | normal             | Create Method at point                      |
| SPC m a             | normal             | Add parameter to current method             |
| SPC m a             | normal             | Add parameter to current method             |
| SPC m v             | normal             | extract variable                            |
| SPC m V             | normal             | extract constant                            |
