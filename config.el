...
(load (expand-file-name "modules/rails-routes.el" doom-private-dir))
(load (expand-file-name "modules/rails-http-status.el" doom-private-dir))
(load (expand-file-name "modules/library_fixes.el" doom-private-dir))
(load (expand-file-name "modules/rubocop.el" doom-private-dir))
(load (expand-file-name "modules/rails-function.el" doom-private-dir))
(load (expand-file-name "modules/editor.el" doom-private-dir))
(load (expand-file-name "modules/ruby.el" doom-private-dir))
(load (expand-file-name "modules/company.el" doom-private-dir))
(load (expand-file-name "modules/kubernetes.el" doom-private-dir))
(load (expand-file-name "modules/projectile-rails-custom-finders.el" doom-private-dir))
