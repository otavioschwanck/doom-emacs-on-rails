...
(map! :desc "Harpoon 1" "C-1" '+workspace/switch-to-1)
(map! :desc "Harpoon 2" "C-2" '+workspace/switch-to-2)
(map! :desc "Harpoon 3" "C-3" '+workspace/switch-to-3)
(map! :desc "Harpoon 4" "C-4" '+workspace/switch-to-4)
(map! :desc "Harpoon 5" "C-5" '+workspace/switch-to-5)
(map! :desc "Harpoon 6" "C-6" '+workspace/switch-to-6)
(map! :desc "Harpoon 7" "C-7" '+workspace/switch-to-7)
(map! :desc "Harpoon 8" "C-8" '+workspace/switch-to-8)
(map! :desc "Harpoon 9" "C-9" '+workspace/switch-to-9)

(map! :desc "Workspace 1" :leader "1" '+workspace/switch-to-1)
(map! :desc "Workspace 2" :leader "2" '+workspace/switch-to-2)
(map! :desc "Workspace 3" :leader "3" '+workspace/switch-to-3)
(map! :desc "Workspace 4" :leader "4" '+workspace/switch-to-4)
(map! :desc "Workspace 5" :leader "5" '+workspace/switch-to-5)
(map! :desc "Workspace 6" :leader "6" '+workspace/switch-to-6)
(map! :desc "Workspace 7" :leader "7" '+workspace/switch-to-7)
(map! :desc "Workspace 8" :leader "8" '+workspace/switch-to-8)
(map! :desc "Workspace 9" :leader "9" '+workspace/switch-to-9)
