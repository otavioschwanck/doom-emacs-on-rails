...
(defun +vterm-splitted ()
  ...
  (evil-window-vsplit)
  (+vterm/here nil)
  (rename-buffer "Terminal 2")
  (evil-insert 1)
  (message "Terminals created.  Go back to your code with SPC TAB [ or M-1 to M-9. Switch between terminals with M-h and M-l"))

(defvar +vterm-command-term-1 "docker-compose up" "Command to be executed on terminal 1")
(defvar +vterm-command-term-2 nil "Command to be executed on terminal 2")
...
(defun +vterm-with-command-splitted ()
  ...
  (+workspace/switch-to-final)
  (+vterm/here nil)
  (when +vterm-command-term-1
    (+vterm-send-string +vterm-command-term-1))
  (rename-buffer "Custom Terminal 1")
  (evil-insert 1)
  (evil-window-vsplit)
  (+vterm/here nil)
  (when +vterm-command-term-2
    (+vterm-send-string +vterm-command-term-2))
  (rename-buffer "Custom Terminal 2")
  (evil-insert 1)
  (message "Terminals created.  Go back to your code with SPC TAB [ or M-1 to M-9. Switch between terminals with M-h and M-l"))
