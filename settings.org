...
(after! centaur-tabs
  ...
  (map! "C-1" 'centaur-tabs-select-visible-tab)
  (map! "C-2" 'centaur-tabs-select-visible-tab)
  (map! "C-3" 'centaur-tabs-select-visible-tab)
  (map! "C-4" 'centaur-tabs-select-visible-tab)
  (map! "C-5" 'centaur-tabs-select-visible-tab)
  (map! "C-6" 'centaur-tabs-select-visible-tab)
  (map! "C-7" 'centaur-tabs-select-visible-tab)
  (map! "C-8" 'centaur-tabs-select-visible-tab)
  (map! "C-9" 'centaur-tabs-select-visible-tab)

  (map! "C-c 1" 'centaur-tabs-select-visible-tab)
  (map! "C-c 2" 'centaur-tabs-select-visible-tab)
  (map! "C-c 3" 'centaur-tabs-select-visible-tab)
  (map! "C-c 4" 'centaur-tabs-select-visible-tab)
  (map! "C-c 5" 'centaur-tabs-select-visible-tab)
  (map! "C-c 6" 'centaur-tabs-select-visible-tab)
  (map! "C-c 7" 'centaur-tabs-select-visible-tab)
  (map! "C-c 8" 'centaur-tabs-select-visible-tab)
  (map! "C-c 9" 'centaur-tabs-select-visible-tab)

  (map! :n "C-M-," #'centaur-tabs-backward-group)
  (map! :n "C-M-;" #'centaur-tabs-forward-group)
...
(defun ruby-new-method-from-symbol-at-point--verify-exist (argument)
  (save-excursion
    (goto-char (point-min))
    (if (search-forward (concat "def " argument) (point-max) t)
        nil
