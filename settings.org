...
#+begin_src emacs-lisp
(after! web-mode
  (define-key web-mode-map (kbd "C-c r") #'rails-routes-insert)
  (define-key web-mode-map (kbd "C-c C-r") #'rails-routes-insert-no-cache))

(define-key ruby-mode-map (kbd "C-c r") #'rails-routes-insert)
(define-key ruby-mode-map (kbd "C-c C-r") #'rails-routes-insert-no-cache)
