...
;; (after! inf-ruby-mode
;;   (setq debugger-command "byebug") ;; change from pry to "byebug" for example..
;;   (setq debugger-command "byebug") ;; change from pry to "byebug" for example..
;; (setq inf-ruby-command-to-continue "continue") ;; used on byebug
;;   (setq pry-show-helper nil) ;; show some helper, change to t if you want this
  ;; )
...
;; (setq rspec-docker-command "docker-compose run") ;; You can also put ../ to execute on parent folder of project.
...
;; )
;; (after! flycheck
;; (setq rubocop-append-command '("docker-compose" "run" "web"))
;; )
;; ()
